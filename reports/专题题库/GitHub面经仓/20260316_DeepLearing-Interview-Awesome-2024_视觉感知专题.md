# GitHub 提取：DeepLearing-Interview-Awesome-2024_视觉感知专题

> 来源仓库：[DeepLearing-Interview-Awesome-2024](https://github.com/315386775/DeepLearing-Interview-Awesome-2024/blob/main/VisionPerception/Reference.md)
> 本页共整理 39 道题，尽量保留原仓库答案；若原仓库缺少解析，则自动补齐。
...
> 图示见原仓库资源：assert/arcface.png#pic_center=600x400
...
> 图示见原仓库资源：assert/centernet.jpg#pic_center=600x400
...
> 图示见原仓库资源：assert/cbam.png#pic_center=600x400
...
> 图示见原仓库资源：assert/foucs.jpg#pic_center=600x400
...
> 图示见原仓库资源：assert/detr.png#pic_center=600x400
...
ORB特征提取的主要缺陷在于尺度不变性弱、对光照与视角变化敏感以及特征点易扎堆。改进方向主要集中在金字塔策略优化、特征点均匀化及引入深度学习。
1. **尺度与视角缺陷**：ORB仅通过简单图像金字塔实现弱尺度不变性，缺乏仿射不变性。改进：增加金字塔层数与缩放因子密度，或融合ASIFT思想提升视角鲁棒性。
2. **光照敏感**：BRIEF描述子依赖像素强度对比，易受光照突变影响。改进：采用自适应阈值FAST，或结合深度学习替换为学习型描述子（如SuperPoint）。
3. **分布不均**：特征点易集中在局部高纹理区。改进：采用ORB-SLAM中的四叉树（Quadtree）或网格划分策略，强制特征点在图像中均匀分布，从而提升后续匹配与位姿估计的稳定性。
